...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (lines.Length == 0)
            {
                logger.LogInfo("No string to parse.");
            }
            ...
            Console.WriteLine($"The two that are the furthest apart is {tacoBellone.Name} and {tacoBelltwo.Name}.\nIt is also {miles} miles away.");
